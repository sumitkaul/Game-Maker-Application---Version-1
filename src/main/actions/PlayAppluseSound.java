...
public class PlayAppluseSound implements Action 
{
	...
	public PlayAppluseSound() 
	{
		this.clipName = "/sounds/applause.wav";
	}
	...
	{
		AudioClip sound = Applet.newAudioClip(PlayAppluseSound.class.getResource(clipName));
