...
public class PlayBounceSound implements Action 
{
	...
	{
		this.clipName = "/sounds/bounce.au";
	}
	...
	{
		AudioClip sound = Applet.newAudioClip(PlayBounceSound.class.getResource(clipName));
