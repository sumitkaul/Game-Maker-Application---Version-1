...
public class PlayGameOverSound implements Action 
{
	...
	{
		this.clipName = "/sounds/gameover.wav";
	}
	...
	{
		AudioClip sound = Applet.newAudioClip(PlayGameOverSound.class.getResource(clipName));
